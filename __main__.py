...
if __name__ == '__main__':
   ...
   # Crear canciones
   cancion1 = src.modelo.cancion.Cancion(titulo ="Ajiaco", minutos = 3, segundos = 1, compositor ="Samuel Torres")
   cancion2 = src.modelo.cancion.Cancion(titulo ="Forced Displacement", minutos = 3, segundos = 12, compositor ="Desconocido")
   cancion3 = src.modelo.cancion.Cancion(titulo ="Alegria", minutos = 4, segundos = 27, compositor ="AU")
